...
async def on_ready():
    ...
    # Schedule daily reminder at 11:22 PM ET (temporary for testing)
    scheduler.add_job(
        send_daily_reminder,
        CronTrigger(hour=23, minute=22, timezone=ET),
        id="daily_reminder",
        replace_existing=True,
    )
    scheduler.start()
    print("Scheduler started - daily reminders at 11:22 PM ET")
